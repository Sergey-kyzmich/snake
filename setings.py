...
def setings(data):
    ...
    while run:
        ...
        screen.blit(text_description1, (1450, 50))
        screen.blit(text_description2, (1450, 100))
        screen.blit(text_description3, (1450, 135))
        screen.blit(text_description4, (1450, 170))
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if text["size_field_btn"].collidepoint(event.pos):
                    select_menu(data, ["easy", "normal", "hard"], 1200, 520, "size_field")
...
def create_text():
    ...
    text["sound_btn"] = pygame.Rect(1200, 300, 160, 80)
    ...
    text["clear_btn"] = pygame.Rect(1450, 250, 410, 80)
    print(text["color"])
    with open("content/data.json", "r") as read_json:
        data_json = json.load(read_json)
    t = str(data_json["color"][0])+", "+ str(data_json["color"][1])+", "+ str(data_json["color"][2])
...
def add_text(screen, text):
    screen.blit(text["sound"], (300,300))
    screen.blit(text["music"], (300, 410))
    screen.blit(text["size"], (300, 520))
