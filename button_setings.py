...
def sound_button(screen, event):
    ...
    print("go")
    rect = pygame.Rect(1200, 300, 160, 80)
    run = True
...
def view_button(data, text):
    ...
    if data_json["sound"] == "100":sx,sy =1200+10, 300+5
    elif len(str(data_json["sound"]))==1:sx,sy = 1200+50, 300+5
    else:sx,sy = 1200+25, 300+5
    ...
    pygame.draw.rect(screen, (70, 137, 158), text["size_field_btn"])
    text_field = myfont.render(["easy", "normal", "hard"][data_json["size_field"]-1], True, (0, 0, 0))
    screen.blit(text_field, ([1270,1250, 1290][data_json["size_field"]-1], [515,525,525][data_json["size_field"]-1]))
    ...
    screen.blit(text_field, (1450+25, 250-2))
