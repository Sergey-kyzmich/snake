...
def main_menu(data):#главное меню
    ...
    text_me = myfont.render("О разработчике", True, (245, 175, 71))
    text_me_rect = text_me.get_rect(topleft=(750*kw,520*kh))

    text_exit = myfont.render("Выход", True, (245, 175, 71))
    text_exit_rect = text_exit.get_rect(topleft=(750*kw,620*kh))
    ...
    while run:
        ...
        screen.blit(text_me, (750*kw,520*kh))
        screen.blit(text_exit, (750*kw,620*kh))
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT or pygame.key.get_pressed()[pygame.K_ESCAPE]:
                ...
                if text_setings_rect.collidepoint(mouse) and pygame.mouse.get_pressed()[0]:
                    br_setings = True
                    run = False
                if text_me_rect.collidepoint(mouse) and pygame.mouse.get_pressed()[0]:
                    br_me = True
                    run = False
